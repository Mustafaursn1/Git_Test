...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		// 11. startsWith() methodu ilk characteri kontrol eder.
				...
				System.out.println(a.startsWith(""));//true  //""ICINDE HIC BIR SEY VAR
				...
				//indexini return edecekti
				System.out.println(a.indexOf('w'));//-1	
				
				System.out.println(a.indexOf("d", 4));//7 //4.karakterden sonra d kacinci indexte
